                    ...
                    <div class="card-header">
                        ...
                        <div class="modal-dialog modal-xl" >
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                <label for="add-bot-bot" class="form-label">代码</label>
                                <VAceEditor
...
<script>
import { ref, reactive } from 'vue'//绑定对象用reactive
import $ from 'jquery'
import { useStore } from 'vuex'
import { Modal } from 'bootstrap/dist/js/bootstrap'//关闭api
import { VAceEditor } from 'vue3-ace-editor';//代码框组件，需要放在components里
...
export default {
    ...
    setup(){
        ...
        const add_bot = () => {//一个函数向后端发送创建bot请求
            ...
            $.ajax({
                ...
                success(resp){
                    if(resp.error_message ==="success"){
                         ...
                         botadd.description="",
                         botadd.content="",
                         Modal.getInstance("#add-bot-btn").hide();//id前加#号，实现隐藏弹窗
                         refresh_bots();
                    }else{
        ...
        const update_bot = (bot) => {
            ...
            $.ajax({
                ...
                success(resp){
                    if(resp.error_message ==="success"){
                         Modal.getInstance("#update-bot-modal-"+bot.id).hide();//id前加#号，实现隐藏弹窗
                         refresh_bots();
                    }else{
                        botadd.error_message = resp.error_message;
                    }
